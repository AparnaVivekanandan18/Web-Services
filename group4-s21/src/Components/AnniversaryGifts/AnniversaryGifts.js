...
function AnniversaryGifts()  {
  ...
  function handleChange(value){
   ...
   function navigateToProduct(id){
      window.location.href="/anniversarygifts/" + id;
  };
  ...
  const getProducts=()=>
  {
      Axios.get(backendurl.url + "/products/displayAnniversaryProducts").then((response) =>
          {
                ...
                <Row> {/*Row 1 starts here*/}
                    <Col>
                        <Card body outline color="success" className="mx-auto my-2">
                            <CardBody>
                                <h1 className="title-style">Anniversary Gifts</h1>
                                <h3></h3>
                            </CardBody>
                        </Card>
                    </Col>
