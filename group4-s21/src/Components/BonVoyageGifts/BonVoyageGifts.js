...
function BonVoyageGifts()  {
  ...
  function handleChange(value){
   ...
   function navigateToProduct(id){
      window.location.href="/bonvoyagegifts/" + id;
  };
  ...
  const getProducts=()=>
  {
      Axios.get(backendurl.url +  "/products/displayBonProducts").then((response) =>
          {
            console.log("hello");
                ...
                <Row> {/*Row 1 starts here*/}
                    <Col>
                        <Card body outline color="success" className="mx-auto my-2">
                            <CardBody>
                                <h1 className="title-style">Bon Voyage Gifts</h1>
                                <h3></h3>
                            </CardBody>
                        </Card>
                    </Col>
